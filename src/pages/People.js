                      ...
                      <div className="w-11/12 flex rounded-lg border bg-slate-100 p-[2px] m-auto">
                      ...
                      </div>
                        {
                            people.map(person=>{
                              ...
                              return <div key={person.cognitoId} onClick={()=>openMessage(person.cognitoId)} className="cursor-pointer"><Person key={person.id} receiverId={person.id} name={person.username} email={person.email}/></div>
                              }
                            }
                        )}
                    </div>
