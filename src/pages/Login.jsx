            ...
            <div className="grid sm:grid-cols-2 w-screen mx-auto h-screen">
                ...
                <div>
                    ...
                    <form onSubmit={(e)=>handleSubmit(e)}>
                        ...
                        <input type="text" id="website-admin" value={email} onChange={(e) => setEmail(e.target.value)} className="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-blue-300 p-2.5  dark:bg-gray-50 dark:border-blue-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="me@me.com"/>
                        </div>
                        
                        
                        <label for="website-admin" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Password</label>
                        <div className="flex">
                        <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-blue-500 rounded-l-md dark:bg-blue-700 dark:text-gray-400 dark:border-blue-600">
                            <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#fff" viewBox="0 0 20 20">
                                <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 13a8.949 8.949 0 0 1-4.951-1.488A3.987 3.987 0 0 1 9 13h2a3.987 3.987 0 0 1 3.951 3.512A8.949 8.949 0 0 1 10 18Z"/>
                            </svg>
                        </span>
                        <input type="password" id="website-admin" value={pwd} onChange={(e) => setPwd(e.target.value)} className="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-blue-300 p-2.5  dark:bg-gray-50 dark:border-blue-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="password"/>
                        </div>
                        {isLoading?
                        <button type=""  className="text-white mt-5 flex justify-evenly bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg w-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" >
                        ...
                        <input type="submit"  className="text-white mt-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg w-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" value="Sign In"/>}
                    </form>
                </div>

                <div className="flex justify-between pt-12">
                <p className="w-4/12 h-1 bg-blue-500 mt-2"></p>
                ...
                <div className="mt-12 col-span- text-center">
                    <NavLink to="/signup" className={'text-blue-500 underline '}>Create account</NavLink>
                </div>
                </div>
                </div>
