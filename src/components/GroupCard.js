...
{/* <div className="w-full h-40 max-w-[12em] py-2 mx-auto my-3 bg-white border rounded-lg shadow-sm">
    ...
    <div className="flex flex-col items-center">
        ...
        <div className="shadow-lg mx-auto max-w-[15em] shadow-black p-5 bg-bl rounded-2xl">
            <div className="flesx justify-between">
                ...
                <div className="grid grid-cols-2">
                    ...
                    <div className="mt-6">
                         <h4 className="text-blue-800 text-[14px] font-poppins font-bold">Group Name</h4>
                    </div>
                </div>
