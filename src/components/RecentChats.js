...
{/* <div class="w-full h-40 max-w-[12em] py-2 mx-auto my-3 bg-white border rounded-lg shadow-sm">
    <div class="sticky">
        <button id="dropdownButton" data-dropdown-toggle="dropdown" class="inline-block mr-auto text-gray-500 dark:text-gray-400 rounded-lg text-sm p-1" type="button">
    ...
    <div class="flex flex-col items-center">
        <img class="w-20 h-20 mb-3 rounded-full shadow-lg" src={pic} alt="Bonnie image"/>
        <h5 class=" text-xl font-medium text-gray-900 ">{props.name}</h5>
        ...
        <div className="mt-12 shadow-lg mx-auto w-full shadow-black p-2 rounded-2xl">
            <div className="flex justify-between">
                <div className="flex">
                <img class="w-20 h-20 rounded-full shadow-lg" src={pic} alt="Bonnie image"/>
